...
class AuthorProfile(models.Model):
    ...
    # CHANGED: Store image as binary data instead of file path
    profile_picture_data = models.BinaryField(blank=True, null=True, editable=False)
    profile_picture_name = models.CharField(max_length=255, blank=True)
    profile_picture_type = models.CharField(max_length=50, blank=True)  # e.g., 'image/jpeg'
    ...
    def has_profile_picture(self):
        return bool(self.profile_picture_data)
...
class BlogPost(models.Model):
    ...
    # CHANGED: Store thumbnail as binary data instead of file path
    thumbnail_data = models.BinaryField(blank=True, null=True, editable=False)
    thumbnail_name = models.CharField(max_length=255, blank=True)
    thumbnail_type = models.CharField(max_length=50, blank=True)  # e.g., 'image/jpeg'
