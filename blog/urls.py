...
urlpatterns = [
    ...
    path('thumbnail/<slug:slug>/', views.serve_blog_thumbnail, name='serve_blog_thumbnail'),
    path('profile-picture/<str:username>/', views.serve_author_profile_picture, name='serve_profile_picture'),
